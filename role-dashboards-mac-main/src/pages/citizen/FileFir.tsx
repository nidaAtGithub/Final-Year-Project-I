...
const handleAudioRecording = async () => {
  ...
  try {
    ...
    mediaRecorder.onstop = async () => {
      ...
      try {
        const res = await fetch("http://127.0.0.1:8002/transcribe-audio", {
          method: "POST",
          body: formData,
        });
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      value={formValues.time_of_incident}
                      onChange={(e) =>
                        setFormValues({ ...formValues, time_of_incident: e.target.value })
                      }
                      required
                    />
                  </div>
              ...
              {recordedAudio && (
                <div className="relative flex flex-col items-start gap-2 mt-3 bg-gray-50 p-3 rounded-lg shadow-sm w-full md:w-1/2">
                  ...
                  <audio controls src={recordedAudio} className="w-3/4 rounded-md z-0 mt-5" />
                </div>
              )}
